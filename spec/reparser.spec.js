...
var parser, reparser, assert, converter, TextOM;

reparser = require('..');
parser = require('./simple-parser.js');
assert = require('assert');

converter = reparser(parser());
...
describe('reparser()', function () {
    ...
    it('should return the given parser', function () {
        var altConverter = parser();
        assert(reparser(altConverter) === altConverter);
    });
});

describe('Parser.TextOM.Node#toJSON()', function () {
    it('should be of type `function`', function () {
    ...
    it('should convert a `Node` into an AST', function () {
        ...
        root = converter('A simple sentence.');
    ...
    it('should throw, when not operating on a Node',
        function () {
            assert.throws(function () {
                converter().toJSON.call(Math);
            }, /Math/);
            assert.throws(function () {
                converter().toJSON.call();
            }, /undefined/);
        }
    );
});

describe('Parser.TextOM.Node#toAST(delimeter)', function () {
    it('should be of type `function`', function () {
...
describe('Parser.fromAST(ast)', function () {
    it('should be of type `function`', function () {
...
describe('Parser.TextOM.Parent#prependContent(value)', function () {
    it('should be of type `function`', function () {
...
describe('Parser.TextOM.Parent#appendContent(value)', function () {
    it('should be of type `function`', function () {
...
describe('Parser.TextOM.Parent#replaceContent(value?)', function () {
    it('should be of type `function`', function () {
...
describe('Parser.TextOM.Parent#removeContent()', function () {
    it('should be of type `function`', function () {
